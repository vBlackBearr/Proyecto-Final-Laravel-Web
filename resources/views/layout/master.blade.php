                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <form class="transfot">
                                                ...
                                                <div class="col-md-12">
                                                    <input class="transfot_form" placeholder="Location" type="text"
                                                        name="Location">
                                                </div>
                                                <div class="col-md-12">
                                                    <input class="transfot_form" placeholder="To destination"
                                                        type="text" name="To destination">
                                                </div>
                                                <div class="col-md-12">
                                                    <input class="transfot_form" placeholder="Email" type="text"
                                                        name="Email">
                                                </div>
                                                <div class="col-md-12">
                                                    <input class="transfot_form" placeholder="Contact Number"
                ...
                <div class="col-md-6">
                    <div class="titlepage">
                        ...
                        <p> There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form, by injected humour, There
                        </p>
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="titlepage">
                        <h2>Our Services</h2>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                            suffered alteration in some form, by injected humour, There </p>
                    </div>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="testimonial_box">
                                                    ...
                                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random
                                                        ...
                                                        45 BC, making it over 2000 year</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="full cross_layout">
                                                    <div class="testimonial_box">
                                                        ...
                                                        <p>Contrary to popular belief, Lorem Ipsum is not simply random
                                                            ...
                                                            from 45 BC, making it over 2000 year</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <ul class="location_icon">
                            ...
                            <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>Phone : +(1234)
                                567 890</li>
